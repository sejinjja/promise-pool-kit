...
`npm run check` also validates `CHANGELOG.md` heading format, version ordering, release-date validity, section bullet presence, and `package-lock.json` metadata consistency.
